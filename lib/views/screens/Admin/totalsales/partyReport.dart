...
class PartReport extends StatefulWidget {
  const PartReport({super.key});

  static String routeName = '/partyreport';

  @override
  State<PartReport> createState() => _PartReportState();
}

class _PartReportState extends State<PartReport> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                          ...
                          child: TextFormField(
                            ...
                            onTap: () async {
                              ...
                              if (newSelectedDate != null) {
                                ...
                                await totalSalesController.getData(k: {
                                  'DATE1':
              ...
              FutureBuilder(
                future: totalSalesController.getData(k: {
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasError) {
                    ...
                    return Obx(
                      () => (totalSalesController.PartyData.isEmpty)
                          ? Center(
                              child: Image.asset(
                          ...
                          : ListView.builder(
                              shrinkWrap: true,
                              itemCount: totalSalesController.PartyData.length,
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          ...
                                          settings: RouteSettings(arguments: {
                                            "Id":
                                                "${totalSalesController.PartyData[index]['D_Id']}",
                                            "Name":
                                                "${totalSalesController.PartyData[index]['Hospital_Name']}"
                                          }),
                                        ),
                                      );
                                    },
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                            "₹ ${totalSalesController.PartyData[index]['sum']}",
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontSize:
                                                  getProportionateScreenHeight(
          ...
          Container(
            ...
            child: DefaultButton(
                ...
                press: () async {
                  ...
                  await makePDF(
                    pdf: pdf,
                    data: totalSalesController.PartyData.value,
                  );
