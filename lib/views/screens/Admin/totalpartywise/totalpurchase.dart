...
class TotalPurchasr extends StatefulWidget {
  const TotalPurchasr({super.key});
  static String routeName = '/purchasereport';
  @override
  State<TotalPurchasr> createState() => _TotalPurchasrState();
}

class _TotalPurchasrState extends State<TotalPurchasr> {
